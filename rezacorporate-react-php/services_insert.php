...
if (isset($_POST['boxicon'])) {
  $boxicon=$_POST['boxicon'];
  $headline=$_POST['headline'];
  $subtitle=$_POST['subtitle'];
  $query="INSERT INTO `services` (`id`, `boxicon`, `headline`, `subtitle`) VALUES (NULL, '$boxicon', '$headline', '$subtitle')";
  $db->query($query);
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Insert Services</h5>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                <input type="text" name="boxicon" class="form-control">
                </div>
            </div>
            <div class="row mb-3">
