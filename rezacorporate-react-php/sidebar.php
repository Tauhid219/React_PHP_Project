...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    ...
    <ul id="whyus-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="./whyus_get.php">
          <i class="bi bi-circle"></i><span>Why Us API</span>
        </a>
      </li>
    </ul>
  </li><!-- End Forms Nav -->
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#team-nav" data-bs-toggle="collapse" href="#">
      <i class="bi bi-microsoft-teams"></i><span>Team</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
  ...
  <li class="nav-item">
    ...
    <ul id="contact-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="./contact_msg_get.php">
          <i class="bi bi-circle"></i><span>Contact Message List</span>
        </a>
      </li>
      <li>
        <a href="./contact_get.php">
          <i class="bi bi-circle"></i><span>Contact API</span>
        </a>
      </li>
    </ul>
  </li><!-- End Forms Nav -->
  ...
  <li class="nav-item">
    ...
    <ul id="blog-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="./blog_get.php">
          <i class="bi bi-circle"></i><span>Blog API</span>
        </a>
      </li>
    </ul>
  </li><!-- End Forms Nav -->
